...
class RzdDataset(Dataset):
    ...
    def __init__(
        ...
        self.config = config
        image_file_names = [
            image_path.stem for image_path in self.img_dir.glob("*")
        ]
    ...
    def __getitem__(self, idx):
        ...
        image_path = str(self.img_dir.joinpath(self.images[idx])) + ".png"
        ann_path = str(self.ann_dir.joinpath(self.images[idx])) + ".png"
